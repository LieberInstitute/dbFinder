...
Region coverage plots for Neun+ peaks separated by direction. Plots have 10% padding (5% on each end).
...
## Plots
plotRegionCoverage(neunPeaks.pad[idx], regionCov, groupInfo, annoNear, annoReg, TxDb.Hsapiens.UCSC.hg19.knownGene, seq_len(sum(idx)))
```
