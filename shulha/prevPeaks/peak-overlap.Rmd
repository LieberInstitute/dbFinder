...
runs <- c(paste0('run', 1:4, '-v1.0.10'), 'run5-v1.5.34', 'run6-v1.5.34', 'run7-v1.5.35', 'run8-v1.5.35')
...
df <- data.frame(
    Run = runs,
    cutoffData = rep(c(5, 2), c(1, 7)),
    cutoffF = c(1e-04, 0.05, 0.01, 0.01, rep(c(0.05, 0.01), 2)),
    scalefac = c(32, 32, 32, 1, 32, 32, 32, 32),
    smooth = rep(c(FALSE, TRUE), c(4, 4)),
    minNum = rep(c(NA, 36), c(4, 4)),
    bpSpan = rep(c(NA, 1000, 300), c(4, 2, 2))
)
