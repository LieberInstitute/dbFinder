...
runs <- c(paste0('run', 1:4, '-v1.0.10'), 'run5-v1.5.34', 'run6-v1.5.34')
...
df <- data.frame(
    ...
    cutoffF = c(1e-04, 0.05, 0.01, 0.01, 0.05, 0.01),
    scalefac = c(32, 32, 32, 1, 32, 32),
    smooth = rep(c(FALSE, TRUE), c(4, 2)),
    minNum = rep(c(NA, 36), c(4, 2))
)
